...
#     flat_probs.sort(key=lambda x: x[2])  # Sort by probability
#     # return the smallest float in the list ignoring -1 and 0 but not 0.0
#     # if there are no valid moves, return None
#     # if there are valid moves, return the row and column of the cell with the smallest probability
